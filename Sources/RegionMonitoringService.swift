            ...
            get{
                return Observable.create{
                    ...
                    return Disposables.create{
                        ownerService.enteringObservers.remove(at: ownerService.enteringObservers.index{$0.id == id}!)
                        ownerService = nil
                    }
                }
            }
        ...
        var exiting: Observable<CLRegion>{
            get{
                return Observable.create{
                    ...
                    return Disposables.create{
                        ownerService.exitingObservers.remove(at: ownerService.exitingObservers.index{$0.id == id}!)
                        ownerService = nil
                    }
                }
            }
        ...
        var determinedRegionState: Observable<(CLRegion, CLRegionState)>{
            get{
                return Observable.create{
                    ...
                    return Disposables.create{
                        ownerService.determinedRegionStateObservers.remove(at: ownerService.determinedRegionStateObservers.index{$0.id == id}!)
                        ownerService = nil
                    }
                }
            }
        ...
        var error: Observable<(CLRegion?, NSError)>{
            get{
                return Observable.create{
                    ...
                    return Disposables.create{
                        ownerService.errorObservers.remove(at: ownerService.errorObservers.index{$0.id == id}!)
                        ownerService = nil
                    }
                }
            }
        ...
        var monitoredRegions: Observable<Set<CLRegion>>{
            get{
                return Observable.create{
                    ...
                    return Disposables.create{
                        ownerService.monitoredRegionsObservers.remove(at: ownerService.monitoredRegionsObservers.index{$0.id == id}!)
                        ownerService = nil
                    }
                }
            }
        ...
        var ranging: Observable<([CLBeacon], CLBeaconRegion)>{
            get{
                return Observable.create{
                    ...
                    return Disposables.create{
                        ownerService.rangingObservers.remove(at: ownerService.rangingObservers.index{$0.id == id}!)
                        ownerService = nil
                    }
                }
            }
